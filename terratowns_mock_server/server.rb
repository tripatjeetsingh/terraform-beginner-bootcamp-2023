...
# We will mock having a state or database for our development server
# by setting a global variable. You will never use a global variable 
...
class Home
  ...
  # create some virtual attributes to stores on this object
